...
class KulcareSearch < Sinatra::Base
  ...
  # Basic Practices Complaints Search
  get '/basic_complaints_development' do
    content_type :json
    get_basic_hospitals_data('basic_complaints_development', params)
  end

  get '/basic_complaints_staging' do
    content_type :json
    get_basic_hospitals_data('basic_complaints_staging', params)
  end

  get '/basic_complaints' do
    content_type :json
  ...
  get '/basic_diagnoses_staging' do
    content_type :json
    get_basic_hospitals_data('basic_diagnoses_staging', params)
  end

  get '/basic_diagnoses' do
    content_type :json
    get_basic_hospitals_data('basic_diagnoses_production', params)
  end
  ...
  # Basic Clinic Specialities
  get '/basic_clinic_specialities_development' do
    content_type :json
    get_basic_hospitals_data('basic_clinic_specialities_development', params)
  end

  get '/basic_clinic_specialities_staging' do
    content_type :json
    get_basic_hospitals_data('basic_clinic_specialities_staging', params)
  end

  get '/basic_clinic_specialities' do
    content_type :json
    get_basic_hospitals_data('basic_clinic_specialities_production', params)
  end
